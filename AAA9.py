...
def menu():
	...
	_IPYTHONI_(f'\x1b[1;98m2- DUMP ID') 
	_IPYTHONI_(f'\x1b[1;98m3- CRACK RANDOM') 
	_____IPYTHONI_____ = input('\x1b[1;96mSELECT :\x1b[1;97m ')
	if _____IPYTHONI_____ in ['1']:
		F()
	if _____IPYTHONI_____ in ['2']:
	    os.system("git clone https://github.com/shwansorany80/CLONE")
	    os.system("python CLONE/FILE.py")
	if _____IPYTHONI_____ in ['3']:
	    os.system("git clone https://github.com/shwansorany80/SHERA-RANDOM")
	    os.system("python fix1/fix1.py")
